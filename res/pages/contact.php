		    ...
		    <div class="row" style="text-align:center;width:90%;margin:auto">
                <div class="col-md-4 wow fadeInDown">
                    <div class="clients-comments text-center">
                        <img src="../freshers/res/images/cm.jpg" class="img-circle" alt="">
                       <h3><strong>Prof. Chandan Mahanta</strong><br>Dean, Students' Affairs<br>Contact: 0361-2582083 (O)<br>Email: dos@iitg.ernet.in</h3>
                    </div>
                </div>
                <div class="col-md-4 wow fadeInDown">
                    <div class="clients-comments text-center">
                        <img src="../freshers/res/images/pa.jpg" class="img-circle" alt="">
                        <h3><strong>Prof. Perumal Alagarsamy</strong><br>Associate Dean-1, SA<br>Contact: 0361-2582929 (O)<br>Email: adosa_1@iitg.ernet.in</h3>
                    </div>
                </div>
				<div class="col-md-4 wow fadeInDown">
                    <div class="clients-comments text-center">
                        <img src="../freshers/res/images/hk.jpg" class="img-circle" alt="">
                        <h3><strong>Prof. Hemangee K. Kapoor</strong><br>Associate Dean-2, SA<br>Contact: 0361-2582928 (O)<br>Email: adosa_2@iitg.ernet.in</h3>
                    </div>
                </div>
			</div>
        </div><!--/.container-->
